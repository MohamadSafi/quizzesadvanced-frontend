...
import GradingSchemaDropdown from "../GradingSchemaDropdown";
...
const MultipleChoiceContainer = ({ quiz, initialQuestion }) => {
  ...
  let customGradingSchema = question.meta.gradingSchema === 'CUSTOM';
    ...
    <div className="box-border w-[1104px] flex flex-col py-[50px] px-[70px] items-start justify-start gap-[34px] text-left text-lg text-gray-100 font-ibm-plex-sans border-[1px] border-solid border-darkgray">
      ...
      <div className="flex flex-col items-start justify-start gap-[25px]">
        ...
        <div className="w-[964px] flex flex-row items-start justify-start gap-[15px]">
          <div className="self-stretch relative flex items-center w-[131px] shrink-0">
            Grading schema
          </div>
          <GradingSchemaDropdown initialState={question.meta.gradingSchema} stateHandler={updateSetting("gradingSchema")} enabled={!quiz.archived}/>
        </div>
      </div>
      ...
      <div className="flex flex-col items-start justify-start gap-[10px] font-montserrat">
        ...
        <div className="flex flex-col items-start justify-start gap-[15px] text-darkgray font-ibm-plex-sans">
          {question.meta.answers.map((answer, index) => {
            ...
            return <MultipleChoiceAnswer key={lastKey} quiz={quiz} question={question} setQuestion={setQuestion} index={index} answer={answer} customGradingSchema={customGradingSchema} />}
          )}
